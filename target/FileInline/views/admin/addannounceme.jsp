            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea class="weui_textarea" onkeyup="wordStatic(this);" maxlength="255" id="contentt" placeholder="请填写公告内容！" rows="8" cols="85"></textarea>
                                <span id="num">0</span>/255
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-10">
                                <button class="btn btn-default" id="btn_register" type="submit" onclick="submit()">提交</button>
                            </div>
                        </div>
                </div>
            </div>
