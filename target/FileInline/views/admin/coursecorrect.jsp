        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <h1 style="text-align: center;">修改实验课程信息</h1>
                    </div>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form"  name="reset" action="Updatecourse" id="editfrom" method="post" onsubmit="return check()">
                        <div class="form-group">
                            <label for="id" class="col-sm-2 control-label">课程号</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="id" name="id" readonly="readonly" value="${sessionScope.course.id}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">课程名</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name" name="name" value="${sessionScope.course.name}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="team" class="col-sm-2 control-label">学年</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="team" name="team" value="${sessionScope.course.team}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="credit" class="col-sm-2 control-label">学分</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="credit" name="credit" value="${sessionScope.course.credit}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="batch" class="col-sm-2 control-label">批次</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="batch" name="batch" value="${sessionScope.course.batch}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="studytime" class="col-sm-2 control-label">学时</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studytime" name="studytime" value="${sessionScope.course.studytime}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="teacherid" class="col-sm-2 control-label">任课教师ID</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="teacherid" name="teacherid" value="${sessionScope.course.teacherid}">
                            </div>
                        </div>
                        <p id="msg_pwd" style="margin-left: 150px"></p>
                        <div class="form-group" style="text-align: center">
                            <button class="btn btn-default" id="btn_register" type="submit">提交修改</button>
                        </div>
                        <h4>${resultu}</h4>
                    </form>
                </div>
